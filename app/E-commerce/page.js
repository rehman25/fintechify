          ...
          <div className="row align-items-center">
            ...
            >
              <div className={styles.InnovativeBox}>
                <h4>
                  E-COMMERCE | Deploy fully functional ecommerce solutions
                  quickly and easily
                </h4>
                <p>
                  Drawing on the experience gained by creating various ecommerce
                  portals over the last 10+ years, we have strategized, designed
                  and developed the best practices pre-configured ecommerce
                  storefronts to help deploy enterprise-level ecommerce
                  solutions.
                </p>
