          ...
          <div className="row align-items-center">
            <div className="col-lg-6" data-aos="fade-right" data-aos-duration="500" >
              <div className={styles.InnovativeBox}>
                <h4>GATEWAY PLUS | An integrated switch system for mobile payment services</h4>
                <p>
                  Gateway plus is an optimal solution, especially for telecom and mobile financial service providers, looking for a customized USSD menu hosting system that can be deployed as a communication bridge between USSD Gateway and the Mobile Financial platforms.
                </p>
                <h5 className='mt-5'>Core Components</h5>
                <ul className={styles.ulPoints}>
                  <li><MdOutlineKeyboardDoubleArrowRight />Dashboard Reports</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Telco USSD Gateway</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Client Mgmt</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Features Mgmt</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Channel Mgmt.</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Message Routing</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Data Encryption</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />External System Mgmt.</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Message Transformation</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Auditing Logging</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />User Mgmt</li>
                </ul>
